...
def fixtures(request):
    ...
    response = utils.get_data(URL, "BasketballAPI/data/fixtures.json", LIVE, STORE)
...
def get_contest_fixtures(request):
    URL = utils.create_request_url("/games", request.GET)
    response = utils.get_data(URL, "BasketballAPI/data/contest_game.json", LIVE, STORE)
...
def get_contests(_):
    ...
    contests = utils.get_data(URL, "BasketballAPI/data/handball_contests.json", LIVE, store=False)
    if LIVE and STORE:
...
def get_team_fixtures(request):
    URL = utils.create_request_url("/games", request.GET)
    response = utils.get_data(URL, "BasketballAPI/data/team_fixtures.json", LIVE, STORE)
...
def get_standings(request):
    ...
    response = utils.get_data(URL, "BasketballAPI/data/standings.json", LIVE, STORE)
