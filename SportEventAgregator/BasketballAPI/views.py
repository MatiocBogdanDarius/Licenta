...
def fixtures(request):
    ...
    # utils.write_json_file("BasketballAPI/data/fixtures.json", response)
    response = utils.read_json_file("BasketballAPI/data/fixtures.json")
...
def get_contest_fixtures(request):
    ...
    #
    # response = data['response']
    # utils.write_json_file("BasketballAPI/data/contest_game.json", response)
    response = utils.read_json_file("BasketballAPI/data/contest_game.json")
...
def get_team_fixtures(request):
    ...
    #
    # response = data['response']
    # utils.write_json_file("BasketballAPI/data/team_fixtures.json", response)
    response = utils.read_json_file("BasketballAPI/data/team_fixtures.json")
...
def get_standings(request):
    ...
    #
    # response = data['response']
    # utils.write_json_file("BasketballAPI/data/standings.json", response)
    response = utils.read_json_file("BasketballAPI/data/standings.json")
