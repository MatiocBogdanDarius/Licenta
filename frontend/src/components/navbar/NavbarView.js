            ...
            <Container sx="lg" className={style.container}>
                ...
                <div className={style.buttons}>
                    <div className={style.search_button}
                        onClick={props.searchButtonHandle}
                    >
                        <FontAwesomeIcon
                    ...
                    {props.user ?
                        <div className={style.profile_button}
                             onClick={props.profileButtonHandle}
                        >
                        ...
                        <div className={style.login_button}
                             onClick={props.loginButtonHandle}
                        >
                            <FontAwesomeIcon
